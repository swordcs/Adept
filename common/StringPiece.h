...
public:
  ...
  StringPiece(const char *str, size_type length) : data_(str), length_(length) {}

  StringPiece(const std::string &str) : data_(str.data()), length_(str.length()) {}

  StringPiece(const StringPiece &that) : data_(that.data_), length_(that.length_) {}
