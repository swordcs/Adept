...
public:
      ...
      Message &message, ITable &table, uint32_t tid, uint32_t tid_offset, const void *key, uint32_t key_offset)
  {
    ...
    auto message_piece_header = MessagePiece::construct_message_piece_header(
        static_cast<uint32_t>(AriaMessage::SEARCH_REQUEST), message_size, table.tableID(), table.partitionID());
      ...
      Message &message, ITable &table, uint32_t tid, const void *key, uint32_t epoch, bool is_write)
  {
    ...
    auto message_piece_header = MessagePiece::construct_message_piece_header(
        static_cast<uint32_t>(AriaMessage::RESERVE_REQUEST), message_size, table.tableID(), table.partitionID());
      ...
      const void *key, uint32_t epoch, bool is_write)
  {
    ...
    auto message_piece_header = MessagePiece::construct_message_piece_header(
        static_cast<uint32_t>(AriaMessage::CHECK_REQUEST), message_size, table.tableID(), table.partitionID());
  ...
  static std::size_t new_write_message(Message &message, ITable &table, const void *key, const void *value)
  {
    ...
    auto message_piece_header = MessagePiece::construct_message_piece_header(
        static_cast<uint32_t>(AriaMessage::WRITE_REQUEST), message_size, table.tableID(), table.partitionID());
...
public:
      ...
      MessagePiece inputPiece, Message &responseMessage, ITable &table, std::vector<std::unique_ptr<Transaction>> &txns)
  {
    ...
    auto message_piece_header = MessagePiece::construct_message_piece_header(
        static_cast<uint32_t>(AriaMessage::SEARCH_RESPONSE), message_size, table_id, partition_id);
      ...
      MessagePiece inputPiece, Message &responseMessage, ITable &table, std::vector<std::unique_ptr<Transaction>> &txns)
  {
    ...
    auto message_piece_header = MessagePiece::construct_message_piece_header(
        static_cast<uint32_t>(AriaMessage::CHECK_RESPONSE), message_size, table_id, partition_id);
