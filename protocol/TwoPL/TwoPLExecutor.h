...
public:
  ...
  TwoPLExecutor(std::size_t coordinator_id, std::size_t id, DatabaseType &db, const ContextType &context,
  ...
  void setupHandlers(TransactionType &txn)
      ...
      override
  {
    txn.lock_request_handler = [this, &txn](std::size_t table_id,
    ...
    txn.network_wait_handler   = [this](std::chrono::steady_clock::time_point start) {
      this->add_embedded_network_wait_time(start);
    };
  };
};
}  // namespace aria
