...
public:
  ...
  void clear_read_lock_request_bit() { bitvec &= ~(READ_LOCK_REQUEST_BIT_MASK << READ_LOCK_REQUEST_BIT_OFFSET); }
  ...
  void clear_write_lock_request_bit() { bitvec &= ~(WRITE_LOCK_REQUEST_BIT_MASK << WRITE_LOCK_REQUEST_BIT_OFFSET); }
