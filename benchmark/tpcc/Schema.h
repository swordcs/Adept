...
#define WAREHOUSE_VALUE_FIELDS(x, y)                                                                                  \
  x(FixedString<10>, W_NAME) y(FixedString<20>, W_STREET_1) y(FixedString<20>, W_STREET_2) y(FixedString<20>, W_CITY) \
      y(FixedString<2>, W_STATE) y(FixedString<9>, W_ZIP) y(float, W_TAX) y(float, W_YTD)
...
#define DISTRICT_VALUE_FIELDS(x, y)                                                                                   \
  x(FixedString<10>, D_NAME) y(FixedString<20>, D_STREET_1) y(FixedString<20>, D_STREET_2) y(FixedString<20>, D_CITY) \
      y(FixedString<2>, D_STATE) y(FixedString<9>, D_ZIP) y(float, D_TAX) y(float, D_YTD) y(int32_t, D_NEXT_O_ID)
...
#define CUSTOMER_VALUE_FIELDS(x, y)                                                                                 \
  x(FixedString<16>, C_FIRST) y(FixedString<2>, C_MIDDLE) y(FixedString<16>, C_LAST) y(FixedString<20>, C_STREET_1) \
      y(FixedString<20>, C_STREET_2) y(FixedString<20>, C_CITY) y(FixedString<2>, C_STATE) y(FixedString<9>, C_ZIP) \
          y(FixedString<16>, C_PHONE) y(uint64_t, C_SINCE) y(FixedString<2>, C_CREDIT) y(float, C_CREDIT_LIM)       \
              y(float, C_DISCOUNT) y(float, C_BALANCE) y(float, C_YTD_PAYMENT) y(int32_t, C_PAYMENT_CNT)            \
                  y(int32_t, C_DELIVERY_CNT) y(FixedString<500>, C_DATA)
...
#define HISTORY_KEY_FIELDS(x, y) \
  x(int32_t, H_W_ID) y(int32_t, H_D_ID) y(int32_t, H_C_W_ID) y(int32_t, H_C_D_ID) y(int32_t, H_C_ID) y(uint64_t, H_DATE)
...
#define ORDER_VALUE_FIELDS(x, y) \
  x(float, O_C_ID) y(uint64_t, O_ENTRY_D) y(int32_t, O_CARRIER_ID) y(int8_t, O_OL_CNT) y(bool, O_ALL_LOCAL)
...
#define ORDER_LINE_VALUE_FIELDS(x, y)                                                                                  \
  x(int32_t, OL_I_ID) y(int32_t, OL_SUPPLY_W_ID) y(uint64_t, OL_DELIVERY_D) y(int8_t, OL_QUANTITY) y(float, OL_AMOUNT) \
...
#define ITEM_VALUE_FIELDS(x, y) \
  x(int32_t, I_IM_ID) y(FixedString<24>, I_NAME) y(float, I_PRICE) y(FixedString<50>, I_DATA)
...
#define STOCK_VALUE_FIELDS(x, y)                                                                                   \
  x(int16_t, S_QUANTITY) y(FixedString<24>, S_DIST_01) y(FixedString<24>, S_DIST_02) y(FixedString<24>, S_DIST_03) \
      y(FixedString<24>, S_DIST_04) y(FixedString<24>, S_DIST_05) y(FixedString<24>, S_DIST_06)                    \
          y(FixedString<24>, S_DIST_07) y(FixedString<24>, S_DIST_08) y(FixedString<24>, S_DIST_09)                \
              y(FixedString<24>, S_DIST_10) y(float, S_YTD) y(int32_t, S_ORDER_CNT) y(int32_t, S_REMOTE_CNT)       \
...
template <>
class Serializer<tpcc::warehouse::value>
{
public:
  std::string operator()(const tpcc::warehouse::value &v) { return Serializer<decltype(v.W_YTD)>()(v.W_YTD); }
};

template <>
class Deserializer<tpcc::warehouse::value>
{
public:
...
template <>
class ClassOf<tpcc::warehouse::value>
{
public:
  static constexpr std::size_t size() { return ClassOf<decltype(tpcc::warehouse::value::W_YTD)>::size(); }
};

template <>
class Serializer<tpcc::district::value>
{
public:
...
template <>
class Deserializer<tpcc::district::value>
{
public:
...
template <>
class ClassOf<tpcc::district::value>
{
public:
...
template <>
class Serializer<tpcc::customer::value>
{
public:
...
template <>
class Deserializer<tpcc::customer::value>
{
public:
...
template <>
class ClassOf<tpcc::customer::value>
{
public:
  static constexpr std::size_t size()
  {
...
template <>
class Serializer<tpcc::stock::value>
{
public:
...
template <>
class Deserializer<tpcc::stock::value>
{
public:
...
template <>
class ClassOf<tpcc::stock::value>
{
public:
  static constexpr std::size_t size()
  {
