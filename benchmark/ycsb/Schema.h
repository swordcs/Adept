...
#define YCSB_VALUE_FIELDS(x, y)                                                                                        \
  x(FixedString<YCSB_FIELD_SIZE>, Y_F01) y(FixedString<YCSB_FIELD_SIZE>, Y_F02) y(FixedString<YCSB_FIELD_SIZE>, Y_F03) \
      y(FixedString<YCSB_FIELD_SIZE>, Y_F04) y(FixedString<YCSB_FIELD_SIZE>, Y_F05)                                    \
          y(FixedString<YCSB_FIELD_SIZE>, Y_F06) y(FixedString<YCSB_FIELD_SIZE>, Y_F07)                                \
              y(FixedString<YCSB_FIELD_SIZE>, Y_F08) y(FixedString<YCSB_FIELD_SIZE>, Y_F09)                            \
...
template <>
class Serializer<ycsb::ycsb::value>
{
public:
  std::string operator()(const ycsb::ycsb::value &v)
  {
    return Serializer<decltype(v.Y_F01)>()(v.Y_F01) + Serializer<decltype(v.Y_F02)>()(v.Y_F02) +
           Serializer<decltype(v.Y_F03)>()(v.Y_F03) + Serializer<decltype(v.Y_F04)>()(v.Y_F04) +
           Serializer<decltype(v.Y_F05)>()(v.Y_F05) + Serializer<decltype(v.Y_F06)>()(v.Y_F06) +
           Serializer<decltype(v.Y_F07)>()(v.Y_F07) + Serializer<decltype(v.Y_F08)>()(v.Y_F08) +
           Serializer<decltype(v.Y_F09)>()(v.Y_F09) + Serializer<decltype(v.Y_F10)>()(v.Y_F10);
  }
};

template <>
class Deserializer<ycsb::ycsb::value>
{
public:
...
template <>
class ClassOf<ycsb::ycsb::value>
{
public:
  static constexpr std::size_t size() { return ClassOf<decltype(ycsb::ycsb::value::Y_F01)>::size() * 10; }
};
